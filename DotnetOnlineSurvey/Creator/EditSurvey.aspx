<%@ Page Title="" Language="C#" MasterPageFile="~/Creator/CreatorMaster.master" AutoEventWireup="true" CodeFile="EditSurvey.aspx.cs" Inherits="Creator_EditSurvey" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            $("#updateSurveyToDb").click(function () {
                //To Delete Previous Question
                $.ajax({
                    type: "POST",
                    url: "../WebMethods/CreateTakeSurvey.asmx/DeleteAllFromSurvey",
